...
def generate_launch_description():
    ...
    #namespace_mavros = PythonExpression(["'ASV' + str(", my_id, ")"])
    ...
    #                     'launch/apm.launch.xml')),
    #    # Aquí defines los argumentos que quieres pasar al archivo XML
    #    launch_arguments={
    #        'namespace': namespace_mavros  # Cambia 'tu_namespace_deseado' por el valor que deseas
    #    }.items()
    #)
    ...
    imu_fix_ext_node = Node (
        ...
        name= "imu_fix_ext",
        namespace= 'control',
        remappings=[("/mavros/imu/data", "/imu_ext/data"),
