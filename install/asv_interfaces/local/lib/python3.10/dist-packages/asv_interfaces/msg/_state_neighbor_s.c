...
bool asv_interfaces__msg__state_neighbor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("asv_interfaces.msg._state_neighbor.StateNeighbor", full_classname_dest, 48) == 0);
  }
  asv_interfaces__msg__StateNeighbor * ros_message = _ros_message;
  {  // id
  ...
  {  // msg_from
    PyObject * field = PyObject_GetAttrString(_pymsg, "msg_from");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->msg_from = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of StateNeighbor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("asv_interfaces.msg._state_neighbor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StateNeighbor");
  ...
  {  // msg_from
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->msg_from);
    {
      int rc = PyObject_SetAttrString(_pymessage, "msg_from", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
